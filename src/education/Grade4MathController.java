...
public class Grade4MathController implements Initializable {
    @FXML
    ...
    public void set_scene() throws IOException {
        ...
        Parent rootGrade4MathScene = FXMLLoader.load(getClass().getResource("Grade4Math.fxml"));
        scene = new Scene(rootGrade4MathScene);
    ...
    public void comboBoxSelect() {
        try {
            ...
            br = new BufferedReader(new FileReader("C:\\Users\\Weisslogia\\IdeaProjects\\E-Ducation\\src\\education\\Assets\\Textbooks\\Grade 4\\Math\\" + comboBox.getValue() + ".txt"));
            String prevlines = "";
            String newlines;
