...
public class Grade4EnglishController implements Initializable {
    @FXML
    ...
    public void set_scene() throws IOException {
        ...
        Parent rootGrade4EnglishScene = FXMLLoader.load(getClass().getResource("Grade4English.fxml"));
        scene = new Scene(rootGrade4EnglishScene);
    ...
    public void comboBoxSelect() {
        try {
            ...
            br = new BufferedReader(new FileReader("C:\\Users\\Weisslogia\\IdeaProjects\\E-Ducation\\src\\education\\Assets\\Textbooks\\Grade 4\\English\\" + comboBox.getValue() + ".txt"));
            String prevlines = "";
            String newlines;
