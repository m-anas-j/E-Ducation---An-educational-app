...
public class Grade5MathController implements Initializable {
    @FXML
    ...
    public void set_scene() throws IOException {
        ...
        Parent rootGrade5MathScene = FXMLLoader.load(getClass().getResource("Grade5Math.fxml"));
        scene = new Scene(rootGrade5MathScene);
    ...
    public void comboBoxSelect() {
        try {
            ...
            br = new BufferedReader(new FileReader("C:\\Users\\Weisslogia\\IdeaProjects\\E-Ducation\\src\\education\\Assets\\Textbooks\\Grade 5\\Math\\" + comboBox.getValue() + ".txt"));
            String prevlines = "";
            String newlines;
