...
public class Grade5GeographyController implements Initializable {
    ...
    public void set_scene() throws IOException
    {
        ...
        Parent rootGrade5GeographyScene = FXMLLoader.load(getClass().getResource("Grade5Geography.fxml"));
        scene = new Scene(rootGrade5GeographyScene);
    ...
    public void comboBoxSelect()
    {
        try
        {
            br = new BufferedReader(new FileReader("C:\\Users\\Weisslogia\\IdeaProjects\\E-Ducation\\src\\education\\Assets\\Textbooks\\Grade 5\\Geography\\" + comboBox.getValue() + ".txt"));
