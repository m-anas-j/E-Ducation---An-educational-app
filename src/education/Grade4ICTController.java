...
public class Grade4ICTController implements Initializable {
    @FXML
    ...
    public void set_scene() throws IOException {
        ...
        Parent rootGrade4ICTScene = FXMLLoader.load(getClass().getResource("Grade4ICT.fxml"));
        scene = new Scene(rootGrade4ICTScene);
    ...
    public void comboBoxSelect() {
        try {
            ...
            br = new BufferedReader(new FileReader("C:\\Users\\Weisslogia\\IdeaProjects\\E-Ducation\\src\\education\\Assets\\Textbooks\\Grade 4\\ICT\\" + comboBox.getValue() + ".txt"));
            String prevlines = "";
            String newlines;
