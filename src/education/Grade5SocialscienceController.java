...
public class Grade5SocialscienceController implements Initializable {
    ...
    public void set_scene() throws IOException
    {
        ...
        Parent rootGrade5SocialscienceScene = FXMLLoader.load(getClass().getResource("Grade5Socialscience.fxml"));
        scene = new Scene(rootGrade5SocialscienceScene);
    ...
    public void comboBoxSelect()
    {
        try
        {
            br = new BufferedReader(new FileReader("C:\\Users\\Weisslogia\\IdeaProjects\\E-Ducation\\src\\education\\Assets\\Textbooks\\Grade 5\\Social Science\\" + comboBox.getValue() + ".txt"));
            //br = new BufferedReader(new FileReader("C:\\Users\\Weisslogia\\IdeaProjects\\E-Ducation\\src\\education\\Assets\\Textbooks\\Grade 5\\History\\"+comboBox.getValue()+".txt"));
            String prevlines = "";
            String newlines;
