...
public class Grade5HistoryController implements Initializable {
    ...
    public void set_scene() throws IOException
    {
        ...
        Parent rootGrade5HistoryScene = FXMLLoader.load(getClass().getResource("Grade5History.fxml"));
        scene = new Scene(rootGrade5HistoryScene);
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
        ...
        String chaptername;
        comboBox.getItems().addAll("Contents","Chapter 1,2,3","Chapter 4","Chapter 5","Chapter 6","Chapter 7");
